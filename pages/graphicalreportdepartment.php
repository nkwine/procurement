...
<body class="hold-transition login-page">
  ...
  <!-- /.login-logo -->
  <h1 style="margin-bottom:1%; margin-top: -6%"><strong>Graphical Report By Department</strong></h1>
...
<script src="morris.min.js"></script>
  ...
  // the chart.
  data: [
    { year: 'Department 1', value: 30 },
    { year: 'Department 2', value: 13 },
    { year: 'Department 3', value: 22 },
    { year: 'Department 4', value: 43 },
    { year: 'Department 5', value: 14 }
  ],
