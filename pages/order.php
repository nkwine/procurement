        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Purchase Order Table</h3> <button class="btn btn-success btn-sm" style="margin-left:1%" data-toggle="modal" data-target="#add"><i class="fa fa-plus"> Add</i></button> <a href="orderdetail.php"><button class="btn btn-info btn-xs" style="margin-left:68%" ><i class="fa fa-eye"> View Detail</i></button></a>
