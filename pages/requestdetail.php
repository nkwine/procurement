        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="requestdetail.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Request Detail</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Purchase Request Detail</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Purchase Request Detail Table</h3> <button class="btn btn-success btn-sm" style="margin-left:1%" data-toggle="modal" data-target="#add"><i class="fa fa-plus"> Add</i></button>
            ...
            <div class="card-body" >
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>B11101000</td>
                  <td>10</td>
                  <td><i style="color: blue"><strong>300</strong></i></td>
                  <td><i style="color: blue"><strong><u>3,000</u></strong></i></td>
                  <td>2<sup>nd</sup></td>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="card-header">
             <h3 class="card-title" align="center">Edit Request</h3>
              </div>
                <div class="card-body">
                  <div class="col-sm-12">
                      <!-- text input -->
