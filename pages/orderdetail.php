    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="proplan.php" class="nav-link"><i class="nav-icon fa fa-clone"></i><p> Procurement Plan</p></a>
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="orderdetail.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Order Detail</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Purchase Order Detail</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Purchase Order Detail Table</h3> <button class="btn btn-success btn-sm" style="margin-left:1%" data-toggle="modal" data-target="#add"><i class="fa fa-plus"> Add</i></button>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="card-header">
                <h3 class="card-title" align="center">Add Order</h3>
              </div>
                <div class="card-body">
                  <div class="col-sm-12">
                      <!-- text input -->
            ...
            <div class="card-body" >
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>1011111</td>
                  <td>Bag</td>
                  <td><i style="color: blue"><strong>3</strong></i></td>
                  <td><i style="color: blue"><strong><u>$100</u></strong></i></td>
                  <td><strong style="color: red">$300</strong></td>
                  <td>1<sup>st</sup></td>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="card-header">
              <h3 class="card-title" align="center">Edit Order</h3>
              </div>
                <div class="card-body">
                  <div class="col-sm-12">
                      <!-- text input -->
