        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Purchase Request Table</h3> <button class="btn btn-success btn-sm" style="margin-left:1%" data-toggle="modal" data-target="#add"><i class="fa fa-plus"> Add</i></button> <a href="requestdetail.php"><button class="btn btn-info btn-xs" style="margin-left:67%" ><i class="fa fa-eye"> View Detail</i></button></a>
                ...
                <div class="card-body">
                  ...
                  <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" placeholder="00.00">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <!-- text input -->
