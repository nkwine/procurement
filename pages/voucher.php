        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Voucher Table</h3> <button class="btn btn-success btn-sm" style="margin-left:1%" data-toggle="modal" data-target="#add"><i class="fa fa-plus"> Add</i></button> <a href="order.php"><button class="btn btn-info btn-xs" style="margin-left:72%" ><i class="fa fa-eye"> View Order</i></button></a>
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exampleInputEmail1" disabled="" value="00.00">
                  </div>
                  </div>
               </div>
                <div class="row">
                    <div class="col-sm-2">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Bir %</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="%" style="color: blue">
                  </div>
                  </div>
                  <div class="col-sm-4">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Bir Amt</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exampleInputEmail1"  placeholder="%" style="color: blue">
                  </div>
                  </div>
                  <div class="col-sm-4">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Income Amt</label>
                    <input type="number" class="form-control" id="exampleInputEmail1"  placeholder="00.00">
                  </div>
                  </div>
               </div>
               <div class="row">
                    <div class="col-sm-2">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Net Amt</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="00.00">
                  </div>
                  </div>
                  <div class="col-sm-2">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Ext. Expense</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="00.00">
                  </div>
                  </div>
                  <div class="col-sm-3">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Due Bir</label>
                     <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter ...">
                  </div>
                  </div>
                  <div class="col-sm-2">
                  ...
                  <div class="col-sm-3">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Processed By</label>
                    <input type="text" class="form-control" id="exampleInputEmail1"  placeholder="Enter ...">
                  </div>
                  </div>
               </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>101111</td>
                  <td>30,000</td>
                  <td><i style="color: blue">10<sup>%</sup></i></td>
                  <td><strong style="color: blue">3,000</strong></td>
                  <td><i style="color: blue">90<sup>%</sup></i></td>
                  <td><strong style="color: blue">27,000</strong></td>
                  <td><strong style="color: blue"><i><u>30,000</u></i></strong></td>
                  <td>1,0000</td>
                  <td>Data</td>
                  <td>1M</td>
                  <td>John Esmail</td>
